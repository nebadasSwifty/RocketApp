...
final class RocketModuleTests: XCTestCase {
    ...
    override func setUpWithError() throws {
        ...
        rocketModel = Rocket(height: .init(meters: 0.3, feet: 0.4),
                             diameter: .init(meters: 0.3, feet: 0.4),
                             mass: .init(kg: 3, lb: 4),
                             firstStage: .init(engines: 3, fuelAmountTons: 2, burnTimeSec: 2),
                             secondStage: .init(engines: 4, fuelAmountTons: 1, burnTimeSec: 1),
                             payloadWeights: [.init(id: "baz", name: "foo", kg: 30, lb: 20)],
                             flickrImages: ["baz"],
                             name: "foo",
                             costPerLaunch: 300,
                             firstFlight: "baz",
